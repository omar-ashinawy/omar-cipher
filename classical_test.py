...
tester = Tester()
tester.test_encryption('../Input Files/Caesar', 'caesar_plain', 'caesar_cipher_3', 'caesar', 3)
tester.test_encryption('../Input Files/Caesar', 'caesar_plain', 'caesar_cipher_6', 'caesar', 6)
tester.test_encryption('../Input Files/Caesar', 'caesar_plain', 'caesar_cipher_12', 'caesar', 12)
...
tester.test_encryption('../Input Files/Vigenere', 'vigenere_plain', 'vigenere_cipher_auto', 'vigenere', 'aether', True)
tester.test_encryption('../Input Files/Vigenere', 'vigenere_plain', 'vigenere_cipher_repeat', 'vigenere', 'pie', False)
